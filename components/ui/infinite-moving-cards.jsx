    ...
    return (
        <div
            ...
            <ul
                ...
                {items.map((item, idx) => (
                    <li
                        className='relative w-[350px] max-w-full shrink-0 rounded-2xl border  bg-[linear-gradient(110deg,_#333_0.6%,_#222)] px-8 py-6 md:w-[450px] dark:border-zinc-700 dark:bg-[linear-gradient(180deg,#27272a,#18181b)]'
                        key={item.name}>
                        <>
                            <div
                                aria-hidden='true'
